...
Assignment: Lab 5[D] Numbers


This program will ask the user to input two integer values and 
returns the number of prime numbers within the range of those two values
inclusively
...
int main(){
	...
	cout << countPrimes(firstnum, secnum) << endl;
