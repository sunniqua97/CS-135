...
Assignment: Lab 5[E] Numbers


This program will ask the user to input an integer value and will determine 
if the value is a twin prime. If it is, the function will output "Yes", if not "No".
A twin prime is a prime number in which if you subtract two from, or add two from, it will
result in another prime number

ex:

Enter an integer: 5

Yes (Because 3 and 7 are prime numbers)
...
int main(){
	...
	if ( isTwinPrime(firstnum) ){
	
		cout << "Yes" << endl;
		// returns Yes if the int firstnum is a twin prime
		...
		cout << "No" << endl;
		// If it's not a twin prime, returns No
